...
if Rapid == false
    ...
    indices_train=[1:600,757:757+1000];
    ...
    indices_validation=[601:756,1758:length(ADS.Files)];
...
Mosquito_Labels = repelem(categorical("mosquito"),756,1);
Background_Labels = repelem(categorical("unknown"),1400,1);


labelsTrain=[Mosquito_Labels(1:600);Background_Labels(1:1001)];
labelsValidation = [Mosquito_Labels(601:756);Background_Labels(1002:1400)];
